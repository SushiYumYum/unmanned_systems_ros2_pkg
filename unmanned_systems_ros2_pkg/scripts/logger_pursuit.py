...
def main():
	...
	pursuer_node = OdomLocNode("pursuer")  #used to be odom_node
	...
	#myData = ["x", "y"]
	# myData = ["time", "Actual Heading"]  # Hw5,P1
	myData = ["time", "x", "y","yaw", "vel_x", "vel_y"]
	...
	while rclpy.ok():
		...
		#myData = [now, pursuer_node.current_position[0], pursuer_node.current_position[1],
			#pursuer_node.orientation_euler[2], pursuer_node.linear_vel_x, pursuer_node.angular_vel_z]

		#myData = [now, pursuer_node.orientation_euler[2]]  # For H5,P1
		myData = [pursuer_node.current_position[0], pursuer_node.current_position[1]]
		myData = [now,
			pursuer_node.current_position[0],
			pursuer_node.current_position[1],
			pursuer_node.orientation_euler[2],
			pursuer_node.linear_vel_x,
			pursuer_node.angular_vel_z,
